...
function Quiz(props){
    ...
    const [isCorrentDelay, setIsCorrectDelay] = useState(undefined)
        ...
        <div className='paying-attention-frontend' style={{backgroundColor:props.bgColor, textAlign:props.theAlignment}}>
            ...
            <ul>
                {props.answers.map(function(answer, index){
                    return (
                    <li className={(isCorrentDelay === true && index == props.correctAnswer ? 'no-click' : '') + (isCorrentDelay === true && index != props.correctAnswer ? 'fade-incorrect' : '')}  onClick={isCorrent === true ? undefined : () => handleAnswer(index)}>
                        {isCorrentDelay === true && index == props.correctAnswer && (
