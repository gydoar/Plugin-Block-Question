...
function Quiz(props) {
  const [isCorrent, setIsCorrect] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined);
  const [isCorrentDelay, setIsCorrectDelay] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      className: (isCorrentDelay === true && index == props.correctAnswer ? 'no-click' : '') + (isCorrentDelay === true && index != props.correctAnswer ? 'fade-incorrect' : ''),
      onClick: isCorrent === true ? undefined : () => handleAnswer(index)
    }, isCorrentDelay === true && index == props.correctAnswer && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    ...
    className: 'correct-message' + (isCorrent == true ? ' correct-message--visible' : '')
    ...
    className: 'incorrect-message' + (isCorrent === false ? ' correct-message--visible' : '')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    height: "24",
